...
sns.kdeplot(am_907_background, bw_adjust=0.65, fill=True, color='lightcoral', ax=axes[2, 0])
sns.kdeplot(am_907_anomalies, bw_adjust=0.65, fill=True, color='red', ax=axes[2, 0])

sns.kdeplot(co_907_background, bw_adjust=0.65, fill=True, color='cornflowerblue', ax=axes[2, 1])
sns.kdeplot(co_907_anomalies, bw_adjust=0.65, fill=True, color='blue', ax=axes[2, 1])

sns.kdeplot(do_907_background, bw_adjust=0.65, fill=True, color='mediumpurple', ax=axes[2, 2])
sns.kdeplot(do_907_anomalies, bw_adjust=0.65, fill=True, color='purple', ax=axes[2, 2])

sns.kdeplot(ph_907_background, bw_adjust=0.65, fill=True, color='dimgray', ax=axes[2, 3])
sns.kdeplot(ph_907_anomalies, bw_adjust=0.65, fill=True, color='darkgray', ax=axes[2, 3])

sns.kdeplot(tu_907_background, bw_adjust=0.65, fill=True, color='gold', ax=axes[2, 4])
sns.kdeplot(tu_907_anomalies, bw_adjust=0.65, fill=True, color='goldenrod', ax=axes[2, 4])
...
# Save the plot
plt.savefig(f'plots/distributions.pdf', format="pdf", dpi=300, bbox_inches='tight')
